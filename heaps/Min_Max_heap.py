...
#Max heap needs a bit of work. the 0 on first index is gone
class MaxHeap:
    def __init__(self, array):
        print(array)
    ...
    def getChild(self, index):
        ...
        else: #compares heap values and returns the bigger
            if self.heap[index * 2] > self.heap[index * 2 + 1]:
                return index * 2
            else:
                return index * 2 + 1
...
array = [3, 5, 6, 1, 2, -6, 0, 33, 65, 78, -99, 0, 88]
min_heap = MaxHeap(array)
# print(min_heap.getMin())
# print(min_heap.getMin())
print(min_heap.getMax())
# print(min_heap.heap)
